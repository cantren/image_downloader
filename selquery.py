...
## Need to install https://github.com/mozilla/geckodriver/releases
## on a mac, copy geckodriver to /usr/local/bin

## Put search terms in that file

## Based on script from https://simply-python.com/2015/05/18/saving-images-from-google-search-using-selenium-and-python/
...
class GoogleImageExtractor(object):
    ...
    def __init__(self, search_key = '' ):
        ...
        self.postfix_of_search_url = '&source=lnms&tbm=isch'# non changable text
        self.target_url_str = ''
        ...
        self.folder_main_dir_prefix = r'/Users/rajivshah/Code/image_scraping'
    ...
    def download_single_image(self, url_link, pic_prefix_str):
        ...
        print (url_link)
        url_link = urllib.unquote((url_link)) #not comprehensive
...
if __name__ == '__main__':
    ...
    if choice ==4:
        ...
        searchlist_filename = r'/Users/rajivshah/Code/image_scraping/list.txt'
